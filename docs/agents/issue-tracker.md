...
- **Child ticket**: a GitHub sub-issue. Where sub-issues aren't enabled, link it from the map with a task list and `Part of #<map>`.
...
- **Resolve**: comment with the answer, close the ticket, then append its result to the map.
